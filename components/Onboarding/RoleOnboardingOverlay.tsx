...
const STEPS: Record<Role, Step[]> = {
  owner: [
    ...
    },
    {
      ...
      details: [
        'В разделе «Экскурсии на модерации» вы видите заявки. Можно задать минимальную цену и комиссию платформы.',
        'После одобрения экскурсия появляется в каталоге для менеджеров и промоутеров.',
      ],
      href: '/dashboard/owner/moderation',
      linkLabel: 'Перейти к модерации',
    },
    {
    ...
    },
    {
      ...
      details: [
        ...
        '«Передача билетов» — перенос билетов между партнёрами. «Выдача вещей» — учёт выданного оборудования (эквайринг, мерч).',
      ],
