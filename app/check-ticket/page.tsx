    ...
    <PublicSiteLayout>
      <div className="max-w-lg mx-auto px-3 sm:px-6 py-8 sm:py-12">
        ...
        <p className="text-white/70 text-sm sm:text-base mb-8 leading-relaxed">
          Введите шестизначный номер заказа с чека или из письма — мы покажем экскурсию, дату отправления и
          статус билета.
        </p>

        <div className="glass-card space-y-4">
          <div>
            <label htmlFor="sale-code" className="block text-sm font-medium text-white/90 mb-2">
              Номер заказа (6 цифр)
            </label>
            <input
              id="sale-code"
