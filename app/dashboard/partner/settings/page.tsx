  ...
  const onSubmit = async (data: ChangePasswordFormData) => {
    try {
      ...
      if (result.success) {
        ...
        setPasswordMessage({ type: 'error', text: result.error || 'Ошибка изменения пароля' })
      }
    } catch (error) {
      ...
      <div className="px-4 py-6 sm:px-0">
        <div className="space-y-6 max-w-3xl">
          <div className="glass-card p-6">
            <h2 className="text-2xl font-bold mb-4 text-gradient">Профиль</h2>
            <p className="text-sm text-white/70 mb-4">
              Обновите имя, телефон и фото профиля партнера.
            </p>
          ...
          <div className="glass-card p-6">
            <h2 className="text-2xl font-bold mb-4 text-gradient">Уведомления по email</h2>
            <p className="text-sm text-white/70 mb-4">
              Настройте письма о продажах, возвратах и изменениях рейсов для ваших экскурсий.
            </p>
              ...
              <div className="space-y-4">
                <label className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/60">
                      Письмо при каждой новой продаже по вашим турам.
                    </div>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/60">
                      Уведомления о возвратах по вашим экскурсиям.
                    </div>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/60">
                      Письма об изменениях времени/даты рейсов по вашим турам.
                    </div>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/60">
                      Уведомления о блокировке и разблокировке партнёрского аккаунта.
                    </div>
                  </div>
                </label>
          ...
          <div className="glass-card p-6">
            <h2 className="text-2xl font-bold mb-6 text-gradient">Смена пароля</h2>
          ...
          <div className="glass-card p-6">
            <h2 className="text-2xl font-bold mb-4 text-gradient">Безопасность и сессии</h2>
            <p className="text-sm text-white/70 mb-4">
              Смотрите, откуда входили в аккаунт, и при необходимости завершайте все сессии.
            </p>
          ...
          {/* Изменение email */}
          <div className="glass-card p-6">
            <h2 className="text-2xl font-bold mb-6 text-gradient">Изменение email</h2>
