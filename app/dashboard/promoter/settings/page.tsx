    ...
    <DashboardLayout title="Настройки" navItems={navItems}>
      <div className="px-4 py-6 sm:px-0 space-y-6 max-w-3xl">
        ...
        <div className="glass-card p-6">
          ...
          <p className="text-sm text-white/70 mb-4">
            Управляйте письмами о продажах и отчётами по вашему промо‑ID.
          </p>
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-white/60">
                    Письмо при каждой новой продаже, где вы указаны промоутером.
                  </div>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-white/60">
                    Письма об изменениях рейсов, где есть ваши продажи.
                  </div>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-white/60">
                    Письма о блокировке и разблокировке вашего аккаунта.
                  </div>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3">
                <input
                  type="checkbox"
                  className="mt-1"
                  checked={notifications.notify_promoter_report_email}
                  onChange={(e) =>
                    setNotifications({
                      ...notifications,
                      notify_promoter_report_email: e.target.checked,
                    })
                  }
                />
                <div>
                  ...
                  <div className="text-xs text-white/60">
                    Периодические отчёты по вашим продажам как промоутера.
                  </div>
                </div>
              </label>
